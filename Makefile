...
CFLAGS=main.cpp cfg.cpp ttcards.cpp gfx.cpp sprite.cpp font.cpp audio.cpp card.cpp board.cpp player.cpp card_face.cpp card_collection.cpp card_hand.cpp
LDFLAGS=ttcards
